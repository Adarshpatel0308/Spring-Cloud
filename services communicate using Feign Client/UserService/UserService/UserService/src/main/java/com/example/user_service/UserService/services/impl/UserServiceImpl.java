...
import com.example.user_service.UserService.external.services.HotelService;
...
//        return user;
        ...
        //TODO: Now we are enable the communication between the services by using the --->(FEIGN CLIENT)
